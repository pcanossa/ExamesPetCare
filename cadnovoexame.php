    ...
    <form class="formm" action="" method="post">
        <div class="container ident">
            ...
            if (isset($_POST['registroanimal'])==true) {
                ...
                $_SESSION['cito']=array();
                echo "<script src=\"javascript/escondebotaoreg.js\"></script>";
            }
            ?>
            <?php
            ...
            <?php
                ...
                if (isset($_POST['enviar'])==true) {
                    ...
                    $insert = "INSERT INTO exames (animal, tutor, idade, especie, exame, qtdade, realizador, datareal, estatus, envio) VALUES ('$animal', '$tutor', $idade, '$especie', '$exame', $qtdade, '$realizador', '$data', 'Em Realização', 'Aguardando Envio ao Realizador')";
